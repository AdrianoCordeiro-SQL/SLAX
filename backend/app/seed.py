...
# Script para garantir apenas a conta de demonstração (sem massa de dados sintéticos).
...
def seed():
    print("[seed] Garantindo conta de acesso rápido para demonstração...")
    with Session(engine) as session:
        ...
        if not admin:
            ...
            print(f"[seed] Conta de demonstração criada: {DEMO_ACCOUNT_EMAIL}")
        else:
            print(f"[seed] Conta de demonstração já existe: {DEMO_ACCOUNT_EMAIL}")
